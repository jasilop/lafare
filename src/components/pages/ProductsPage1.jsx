  ...
  return (
    ...
    <Row md="12" className="productionpagerow1" >
       <div className="productspagesection1">
           <Col md="6">
           <img className="productpagemainimage"src={pic1}/>
           </Col>
           <Col md="6" className="productionpagecol1" >
            ...
            <div>
              <p className="productioncolpoints"> 
                  <AiTwotoneMinusCircle/> &nbsp; Flaewah’s instant Kerala Style Chicken Curry paste is a combination of high class spices which will satisfy your cravings.
              </p>
              <p className="productioncolpoints"> 
                  <AiTwotoneMinusCircle/> &nbsp;Just add  Chicken with  Flaewah’s Instant Kerala Style chicken curry  paste.  Then Stir it, Cook it and Serve it.  Your Kerala style Chicken Curry is ready in 15 mins.
              </p>
              {/* <p  className="productioncolpoints"> 
