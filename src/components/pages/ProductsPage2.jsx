           ...
           <Col md="6" className="productionpagecol1" >
            ...
            <div>
              <p className="productioncolpoints"> 
                  <AiTwotoneMinusCircle/> &nbsp; Flaewah’s instant Kerala Style pepper chicken paste is a combination of high class spices which will satisfy your cravings.
              </p>
              <p className="productioncolpoints"> 
                  <AiTwotoneMinusCircle/> &nbsp;Just add  Chicken with  Flaewah’s Instant Kerala Style pepper chicken  paste.  Then Stir it, Cook it and Serve it.  Your Kerala style Pepper Chicken  is ready in 15 mins.
              </p>
              {/* <p  className="productioncolpoints"> 
