  ...
  return (
    ...
    <Row md="12" className="productionpagerow1" >
       <div className="productspagesection1">
           <Col md="6">
           <img className="productpagemainimage"src={pic3}/>
           </Col>
           <Col md="6" className="productionpagecol1" >
            ...
            <div>
              <p className="productioncolpoints"> 
                  <AiTwotoneMinusCircle/> &nbsp; Flaewah’s instant Kerala Style Beef roast paste is a combination of high class spices which will satisfy your cravings.
              </p>
              <p className="productioncolpoints"> 
                  <AiTwotoneMinusCircle/> &nbsp;Just add  Beef with  Flaewah’s Instant Kerala Style Beef roast paste.  Then Stir it, Cook it and Serve it.  Your Kerala style Beef Roast is ready in 15 mins.
              </p>
              {/* <p  className="productioncolpoints"> 
